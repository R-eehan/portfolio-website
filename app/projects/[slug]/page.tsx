...
export async function generateMetadata({
  ...
  return {
    title: `${project.frontmatter.title} | Reehan Ahmed`,
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8">
          <div className="max-w-3xl">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-sm transition-colors duration-200 hover:text-[var(--mono-text)]"
              style={{
                fontFamily: "var(--font-sans)",
                fontWeight: 500,
                color: "var(--mono-muted)",
