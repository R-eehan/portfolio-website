...
metrics: [{ value: "30%", label: "Healing rate" }, { value: "$1M", label: "ARR protected" }]
...
![Providing application-specific context to improve LLM selector quality](/images/case-studies/ai-augmentation/reference-dataset-llm-selector-flow.png)
